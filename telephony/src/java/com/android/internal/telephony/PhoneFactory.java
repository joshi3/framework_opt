...
//                        Rlog.i(LOG_TAG, "Network Type set to " + Integer.toString(networkType));
                    ...
                    if (CdmaFeatureOptionUtils.isEvdoDTSupport()) {
                        ...
                        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()
                                && CdmaFeatureOptionUtils.getExternalModemSlot() == i) {
                ...
                for (int i = 0; i < numPhones; i++) {
                    ...
                    /* For SVLTE support start, assume SVLTE activate on the first sub*/
                    if (i == 0 && CdmaFeatureOptionUtils.isCdmaLteDcSupport()) {
                        ...
                        sCommandsInterfaceLteDc = new RIL(context, networkType,
                                cdmaSubscription, SubscriptionManager.LTE_DC_PHONE_ID);
