        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("com.mtk.TEST_TRM")) {
                ...
                if (mode == 2
                    ...
                    setTrm(mode, null);
                } else if ((mode == MODE_CDMA_ASSERT || mode == MODE_CDMA_RESET)
                        && mInstanceId == 0) {
...
*/
    ...
    */
    ...
    /**
     * To set VT capability to MD to info MD to enable/disable the video call feature.
     * @param enable indication enable or disable vt capability.
     */
    public void setVTCapability(boolean enable) {
        RILRequest rr = RILRequest.obtain(RIL_REQUEST_SET_VT_CAPABILITY, null);
