...
//Added by M end
    ...
    private void fetchRuimRecords() {
        ...
        //mRecordsToLoad++;
        mIccId = SystemProperties.get(SIMRECORD_PROPERTY_ICCID[mPhoneId], "");
    ...
    public void broadcastPhbStateChangedIntent(boolean isReady) {
        ...
        long subId =  mParentApp.getPhoneId();
        if (subId < 0) {
            ...
            intent.putExtra(PhoneConstants.SUBSCRIPTION_KEY, mParentApp.getPhoneId());
            if (DBG) {
