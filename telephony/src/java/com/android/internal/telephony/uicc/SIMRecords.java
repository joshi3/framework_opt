    ...
    */
    ...
    public SIMRecords(UiccCardApplication app, Context c, CommandsInterface ci) {
        ...
        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()
            && (mSlotId == CdmaFeatureOptionUtils.getExternalModemSlot())) {
            mPhone = PhoneFactory.getPhone(SubscriptionManager.LTE_DC_PHONE_ID);
        } else {
...
//MTK-END [mtk80601][111215][ALPS00093395]
    ...
    protected void fetchSimRecords() {
        ...
        //mRecordsToLoad++;
        mIccId = SystemProperties.get(SIMRECORD_PROPERTY_ICCID[mSlotId], "");
