...
public class CdmaConnection extends Connection {
    ...
    static final int CALL_ACCEPTED_TIMEOUT_MILLIS = 20 * 1000;
    /// @}
    ...
    /// M: @{
    static final int EVENT_CALL_ACCEPTED_TIMEOUT = 5;
    /// @}
    ...
    class MyHandler extends Handler {
        ...
        handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                /// M: @{
                case EVENT_CALL_ACCEPTED_TIMEOUT:
                    Rlog.d(LOG_TAG, "processNextPostDialChar for event:" + msg.what);
                /// @}
    ...
    onConnectedInOrOut() {
        ...
        if (!mIsIncoming) {
            ...
            //processNextPostDialChar();
            log("onConnectedInOrOut, sendMessageDelayed for EVENT_CALL_ACCEPTED_TIMEOUT");
            mHandler.sendMessageDelayed(mHandler.obtainMessage(EVENT_CALL_ACCEPTED_TIMEOUT),
                                            CALL_ACCEPTED_TIMEOUT_MILLIS);
            /// @}
        } else {
    ...
    void onCdmaCallAccept() {
        ...
        // send DTMF when the CDMAcall is really accepted.
        if (mHandler.hasMessages(EVENT_CALL_ACCEPTED_TIMEOUT)) {
            Rlog.d(LOG_TAG, "onCdmaCallAccept, processNextPostDialChar");
            mHandler.removeMessages(EVENT_CALL_ACCEPTED_TIMEOUT);
            processNextPostDialChar();
        }
    }
