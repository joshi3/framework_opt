...
public class CdmaSMSDispatcher extends SMSDispatcher {
    ...
    protected SmsTracker getNewSubmitPduTracker(String destinationAddress, String scAddress,
        ...
        if(submitPdu == null) {
            Rlog.d(TAG, "CDMASMSDispatcher.getNewSubmitPduTracker(), L, getSubmitPdu() returned null, A");
            return null;
        } else {
    ...
    protected SmsTracker getNewSubmitPduTracker(String destinationAddress, String scAddress,
        ...
        if (submitPdu != null) {
            ...
            Rlog.e(TAG, "CDMASMSDispatcher.getNewSubmitPduTracker(), L, getSubmitPdu() returned null, B");
			return null;
        }
    }
    // MTK-END
    ...
    public void sendMultipartTextWithExtraParams(String destAddr, String scAddr,
        ...
        for (int i = 0; i < msgCount; i++) {
            ...
            trackers[i] =
                getNewSubmitPduTracker(destAddr, scAddr, parts.get(i), smsHeader, encoding,
                        sentIntent, deliveryIntent, (i == (msgCount - 1)),
                        unsentPartCount, anyPartFailed, messageUri, fullMessageText, validityPeriod, priority);
        }
