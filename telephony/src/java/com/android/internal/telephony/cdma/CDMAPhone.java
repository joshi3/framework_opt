...
public class CDMAPhone extends PhoneBase {
    ...
    private DataRoamingCustomization mDataRoamingCustomizaiton;
    ...
    protected void init(Context context, PhoneNotifier notifier) {
        ...
        /// @}
        /// M: For CT IR data customization
        mDataRoamingCustomizaiton = new DataRoamingCustomization(context, this);
    ...
    public void dispose() {
        synchronized(PhoneProxy.lockForRadioTechnologyChange) {
            ...
            mSubInfo.dispose();
            mEriManager.dispose();
            mDataRoamingCustomizaiton.dispose();
        }
    }
    ...
    public void updatePhoneObject(int voiceRadioTech) {
        if (!(CdmaFeatureOptionUtils.isCdmaLteDcSupport() &&
                mPhoneId == SubscriptionManager.LTE_DC_PHONE_ID)) {
