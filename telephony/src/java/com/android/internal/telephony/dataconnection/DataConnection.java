...
public final class DataConnection extends StateMachine {
    ...
    private NetworkCapabilities makeNetworkCapabilities() {
        ...
        // M: [C2K][IRAT] Change LTE_DC_SUB_ID to IRAT support slot sub ID for
        // IRAT.
        int subId = mPhone.getSubId();
        if (CdmaFeatureOptionUtils.isCdmaLteDcSupport()
                && subId == SubscriptionManager.LTE_DC_SUB_ID) {
            int[] subIds = SubscriptionManager.getSubId(SvlteIratUtils.getIratSupportSlotId());
            ...
            switch (msg.what) {
                ...
                case EVENT_DATA_CONNECTION_DRS_OR_RAT_CHANGED:
                    ...
                    if (!SvlteIratUtils.isIratSupportPhone(mPhone)) {
                        ...
                        final int networkType = SvlteIratUtils.getSvltePhoneProxy()
                                .getIratController().getCurrentRat();
                ...
                case EVENT_DEACTIVATE_DONE:
                    ...
                    if (dp.mTag == mTag) {
                        ...
                        if(ar.result instanceof int []) {
                            ...
                            } else { // setCidArray for response size is 0,
