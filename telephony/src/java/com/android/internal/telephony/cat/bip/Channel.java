...
/*
                        clearChannelBuffer(false);
                        mChannelStatus = BipUtils.CHANNEL_STATUS_LINK_DROPPED;//change state to avoid SAT attempts to send data to server and return BIP error.
                        mChannelStatusData.mChannelStatus = ChannelStatus.CHANNEL_STATUS_NO_LINK;//change state for get channel status command.
