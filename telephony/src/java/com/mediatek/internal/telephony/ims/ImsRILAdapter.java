...
public class ImsRILAdapter extends ImsBaseCommands implements ImsCommandsInterface {
    ...
    */
                            ...
                            case 0:   //record callstring to mCallConnections for MT case.
                                {
                                    ...
                                    Rlog.d(IMS_RILA_LOG_TAG, "Debug: when ECPI:0, callInfo[0] = " + callInfo[0] + ",  mCallConnections size = " + mCallConnections.size());
                                    break;
                                }
                            case 130:   //record callstring to mCallConnections for MO case.
                                {
                                    ...
                                    Rlog.d(IMS_RILA_LOG_TAG, "Debug: when ECPI:130, callInfo[0] = " + callInfo[0] + ",  mCallConnections size = " + mCallConnections.size());
                                    break;
                                }
                            case 2:   //record callstring to mCallConnections for MO case.
                                {
                                    ...
                                    if (imsCallInfo == null) {
                                        Rlog.e(IMS_RILA_LOG_TAG, "Error: imsCallInfo is null when ECPI:2, callInfo[0] = " + callInfo[0] + ", imsCallInfo = " + imsCallInfo + ",  mCallConnections size = " + mCallConnections.size());
                                        break;
                                    }
                            ...
                            case 131:
                                {
                                    imsCallInfo = mCallConnections.get(callInfo[0]);
                                    if (imsCallInfo == null) {
                                        Rlog.e(IMS_RILA_LOG_TAG, "Error: imsCallInfo is null when ECPI:131, callInfo[0] = " + callInfo[0] + ", imsCallInfo = " + imsCallInfo + ",  mCallConnections size = " + mCallConnections.size());
                                        break;
                                    }
                            ...
                            case 132:
                                {
                                    imsCallInfo = mCallConnections.get(callInfo[0]);
                                    if (imsCallInfo == null) {
                                        Rlog.e(IMS_RILA_LOG_TAG, "Error: imsCallInfo is null when ECPI:132, callInfo[0] = " + callInfo[0] + ", imsCallInfo = " + imsCallInfo + ",  mCallConnections size = " + mCallConnections.size());
                                        break;
                                    }
    ...
    private synchronized String executeCommandResponse(String atCmdLine) {
        ...
        try {
            if (mDefaultCi != null) {
                mDefaultCi.invokeOemRilRequestRaw(cmdByte, 
        ...
        if (mDefaultCi != null) {
            if (mConferenceCallDialInfo != null) {
                ...
                if (mMoCall.mIsVideoCall) {                  
                  mDefaultCi.vtDial(mMoCall.mCallee, mMoCall.mClirMode, mMoCall.mResult);
                } else {
